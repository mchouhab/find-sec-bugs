...
public class JDK7013538Detector implements Detector {

	private static final boolean DEBUG = true;
	private static final String JVM_MEMORY_TYPE = "JVM_MEMORY5";
	private final BugReporter bugReporter;

	public JDK7013538Detector(BugReporter bugReporter) {
	...
	public void visitClassContext(ClassContext classContext) {
		...
		for (Method m : methodList) {
			...
			try {
				JavaClass class2 = Repository.lookupClass("testcode.JDK7013538");
