...
public class JDK8067258Detector implements Detector {

	private static final boolean DEBUG = true;
	private static final String JVM_MEMORY_TYPE = "JVM_MEMORY8";
	private final BugReporter bugReporter;

	public JDK8067258Detector(BugReporter bugReporter) {
	...
	public void visitClassContext(ClassContext classContext) {
		...
		for (Method m : methodList) {
			...
			try {
				JavaClass class2 = Repository.lookupClass("testcode.JDK8067258");
