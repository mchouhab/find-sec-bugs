...
public class JDK6795161Detector implements Detector {

	private static final boolean DEBUG = true;
	private static final String JVM_MEMORY_TYPE = "JVM_MEMORY2";
	private final BugReporter bugReporter;

	public JDK6795161Detector(BugReporter bugReporter) {
	...
	public void visitClassContext(ClassContext classContext) {
		...
		for (Method m : methodList) {
			 ...
			 * !(m.getExceptionTable().getNumberOfExceptions() > 0)){ continue;
			 * }
			 */
			...
			try {
				JavaClass class2 = Repository.lookupClass("testcode.JDK6795161");
