...
public class JDK8130847Detector implements Detector {

	private static final boolean DEBUG = true;
	private static final String JVM_MEMORY_TYPE = "JVM_MEMORY9";
	private final BugReporter bugReporter;

	public JDK8130847Detector(BugReporter bugReporter) {
	...
	public void visitClassContext(ClassContext classContext) {
		...
		for (Method m : methodList) {
			...
			try {
				JavaClass class2 = Repository.lookupClass("testcode.JDK8130847");
