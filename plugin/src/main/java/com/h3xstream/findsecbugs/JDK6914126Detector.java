...
public class JDK6914126Detector implements Detector {

	private static final boolean DEBUG = true;
	private static final String JVM_MEMORY_TYPE = "JVM_MEMORY4";
	private final BugReporter bugReporter;

	public JDK6914126Detector(BugReporter bugReporter) {
	...
	public void visitClassContext(ClassContext classContext) {
		...
		for (Method m : methodList) {
			...
			try {
				JavaClass class2 = Repository.lookupClass("testcode.JDK6914126");
